 ...
 * 
 */
package javasmartphone.p1u4.scale;

import javasmartphone.p1u4.adapter.IEditThread;

public class EditOptions extends Thread {
	private String modelName; 
	private int opt; // option code to call witch function
	private IEditThread auto;
	...
	public EditOptions(String name, String modelName, int opt, IEditThread auto) {
		super(name);
	...
	public IEditThread getAuto() {
		return auto;
	}
	
	public void setAuto (IEditThread auto) {
		this.auto = auto;
	}
