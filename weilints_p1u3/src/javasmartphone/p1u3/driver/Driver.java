...
package javasmartphone.p1u3.driver;

import javasmartphone.p1u3.adapter.BuildAuto;
import javasmartphone.p1u3.adapter.ICreateAuto;
import javasmartphone.p1u3.adapter.ISyncUpdateAuto;
import javasmartphone.p1u3.scale.EditOptions;
...
public class Driver {
	...
	public static void main(String[] args) {
		...
		c1.buildAuto("./testData/FordZTW.txt");
		// print out
		 ...
		 *  */
		ISyncUpdateAuto auto = (ISyncUpdateAuto) c1;
