...
import javasmartphone.p1u2.adapter.BuildAuto;
import javasmartphone.p1u2.adapter.ICreateAuto;
import javasmartphone.p1u2.adapter.IUpdateAuto;
...
public class ProxyDriver {
	...
	public static void main(String[] args) {
		...
		// build another car 
		System.out.println("\n--> Build Civic\n");
		c1.buildAuto("./testData/HondaCivic.txt");
		c1.printAuto("Civic");
